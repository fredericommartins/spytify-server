...
genres = ['Indie Rock', 'Acid Rock', 'Trance', 'Reggae', 'Grunge', 'New Romantic', 'Hard Rock', 'Southern Rap', 'Emo & Hardcore', 'Pop Punk', 'Rap Comedy',
    'Heavy Metal', 'Rock', 'Classical', 'Brazilian Pop', 'European Traditional', 'Samba', 'Industrial', 'Other', 'Synth Pop', 'Alternative Rock']
...
def Parse():
    ...
    optional.add_argument('-b', '--begin', metavar='band', type=str, help='Start injecting from band given')
...
for artist in sorted(listdir(args.source)):
    ...
    for album in listdir(artist_path):
        ...
        for music in listdir(album_path):         
            ...
            if tags['TALB'] and tags['TALB'] is not 'Unknown Album':
